    ...
    <>
      ...
      >
        <nav className="container max-w-[88rem] mx-auto flex flex-row items-center justify-between z-50">
          <Link
            href="/"
            className="md:w-[122px] md:h-[32px] w-[100px] h-[28px]"
          >
            <Logo />
          </Link>
          ...
          <ul className="md:flex hidden flow-row items-end justify-start gap-x-[47px]">
            ...
            <li className="text-[#F8F1FF] text-[16px] font-openSans_Medium">
              <Link href="https://ulalo.gitbook.io/ulalo-whitepaper">
                {t("header.gitbook")}
              </Link>
            </li>
            <li className="text-[#F8F1FF] text-[16px] font-openSans_Medium">
              ...
              <Link href="/">{t("header.staking")}</Link>
            </li>
            <li className="text-[#F8F1FF] text-[16px] font-openSans_Medium">
              <Link href="/ambassador-program">
                {t("header.ambassadorProgram")}
              </Link>
            </li>
          </ul>
      ...
      >
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="mt-12 flex flex-col items-center gap-y-5">
            <p className="text-[#364655] text-[20px] font-openSans_Bold">
              {t("header.links")}
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link
                href="https://www.youtube.com/@ULALO_IO"
                onClick={() => setMobileNav(false)}
              >
