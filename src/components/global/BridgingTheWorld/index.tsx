...
const BridgingTheWorld = () => {
  ...
  return (
    <section className="container max-w-[88rem] mx-auto px-5 md:px-8 flex flex-col items-start justify-start gap-y-[56px] py-[100px]">
      <p className="text-[#000] text-[32px] md:text-[56px] font-sfpro_700 flex flex-col items-start justify-start uppercase leading-[110%]">
        {t("headingPart1")}{" "}
        <span className="text-[#1BE866] ">{t("headingPart2")}</span>
      </p>
      ...
      <p className="text-[#000] self-end text-[32px] md:text-[56px] font-sfpro_700 uppercase leading-[110%]">
        {t("footerText")}
      </p>
    </section>
  );
