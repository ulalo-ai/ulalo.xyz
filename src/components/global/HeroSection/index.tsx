...
const HeroSection = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#35E467] to-[#35E467] overflow-hidden relative">
            ...
            <motion.div
                className="max-w-[93rem] hidden md:flex flex-col items-center justify-end h-screen mx-auto px-6 lg:px-8 !pt-56"
            ...
            >
                <div className="flex !w-full relative justify-center flex-col h-[20%]">
                    <motion.h1
                        className="text-[128px] text-white text-start font-black leading-tight"
                    ...
                    <motion.div className="text-white space-y-8 h-full justify-center gap-y-8 flex flex-col" variants={itemVariants}>
                        ...
                        <motion.p style={{
                            ...
                            letterSpacing: "0"
                                  ...
                                  className="text-lg lg:text-xl text-[#374655] leading-relaxed max-w-[33.25rem]"
                                  variants={itemVariants}
                        >
